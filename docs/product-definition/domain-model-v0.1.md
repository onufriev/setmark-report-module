...
| PM-034 | В область продукта входят все отклонения розничной реализации/выбытия; внешний владелец устранения не исключает инцидент из анализа, а указывается отдельно как Set Mark, SetRetail, ГИС МТ или внешний бизнес-процесс |
