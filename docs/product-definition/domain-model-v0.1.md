...
После истечения настроенного срока инцидент и связанные с ним исходный снимок, результат анализа, объяснение и сохранённый контекст обогащения безвозвратно удаляются. Архивирование этих данных в v1 не выполняется.
...
| ID | Вопрос | Влияние |
|---|---|---|
| OQ-DM-012 | Должна ли агрегированная статистика сохраняться после удаления исходных инцидентов? | Аналитика и регуляторный риск |
