...
Действие после истечения срока хранения — удаление, архивирование или обезличивание — требует отдельного решения и до его принятия не должно определяться реализацией самостоятельно.
...
| ID | Вопрос | Влияние |
|---|---|---|
| OQ-DM-011 | Что происходит с инцидентом и связанными данными после истечения срока хранения: удаление, архивирование или обезличивание? | Данные и аудит |
