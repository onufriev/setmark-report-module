...
- [INC-003 — Продажа товара с КИ, незарегистрированными в ГИС](inc-003-unregistered-code-v0.1.md) — согласовано Product Manager
- [INC-004 — Реализация от участника, незарегистрированного в ГИС МТ](inc-004-participant-not-registered-v0.1.md) — согласовано Product Manager
- [INC-005 — Реализация от участника, незарегистрированного в товарной группе](inc-005-participant-product-group-v0.1.md) — согласовано Product Manager
- [INC-006 — Продажа товара без проверки КМ](inc-006-sale-without-code-check-v0.1.md)
- [INC-007 — Продажа товара с некорректным статусом РД](inc-007-invalid-permit-status-v0.1.md) — согласовано Product Manager
- [INC-008 — Повторная реализация товаров, не подлежащих возврату](inc-008-non-returnable-resale-v0.1.md) — согласовано Product Manager
