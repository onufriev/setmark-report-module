...
- [INC-001 — дополнительные ветки второго приоритета](../diagrams/inc-001-second-priority-flow-v0.1.svg)
- [INC-017 — алгоритм разбора](../diagrams/inc-017-analysis-flow-v0.1.svg)
- [INC-018 — алгоритм разбора](../diagrams/inc-018-analysis-flow-v0.1.svg)
- [Единая ветка доказанного отсутствия результата онлайн ЧЗ и ЛМ ЧЗ](../diagrams/proven-no-response-settings-flow-v0.1.svg) — применяется в INC-007, INC-010, INC-011, INC-015, INC-016 и INC-017
...
Перед PR второго приоритета правила сверены по [матрице непротиворечивости](../second-priority-consistency-matrix-v0.1.md).
