...
| Недоступен | Доступен | Разрешено | Продажа; позднее ЧЗ зарегистрировал продажу товара с истекшим сроком годности | RA-01; риск автоштрафа — нет; регуляторный риск — есть |
