...
**То:** установить критичность агрегированного показателя по магазину. Критичность отдельных инцидентов из-за одного только превышения накопленного порога не изменяется. На каждом инциденте, вошедшем в расчёт, сохраняются признак участия в превышенном агрегате и ссылка на него. Применять только правило со статусом «вступило в силу»; пороги из проекта нормативного акта хранить и отображать отдельно как прогнозные.
