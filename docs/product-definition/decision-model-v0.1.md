...
- контур устранения: Set Mark, SetRetail, ГИС МТ или внешний бизнес-процесс;
- вид инцидента;
...
Если отклонение возникло при розничной реализации/выбытии, оно входит в поддерживаемую область независимо от контура устранения. Для такого инцидента указывается один или несколько контуров: Set Mark, SetRetail, ГИС МТ или внешний бизнес-процесс. Внешний контур устранения сам по себе не приводит к `RA-03`.
