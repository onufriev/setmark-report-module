...
3. **Карточка инцидента** — бизнес-правила, корреляция данных, системный сценарий, данные и интеграции; проверяется наличием сохранённых значений полей ЧЗ, понятного результата проверки без технического кода `RA-*`, объяснения, критичности, потенциального штрафа, Контура устранения, рекомендации, полного кода маркировки и PDF.
...
## REQ-DEC-194. Решение Product Manager

**Область:** traceability
**Статус:** Подтверждено Product Manager
**Основание:** PM-DEC-209
**Применимость:** MVP1

Ранее согласованные правила анализа INC-001–INC-018, модель результатов RA-01–RA-05, рекомендации, необходимые действия и уведомления должны быть представлены самодостаточными каноническими требованиями. Определение продукта и производный handoff должны формироваться по актуальному baseline без изменения утверждённых границ MVP.

### Проверка
Реализация соответствует решению PM-DEC-209.
