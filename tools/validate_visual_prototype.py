...
required_features = {
    "brand-logo": "Не встроен оригинальный логотип SetRetail10",
    "loyalty-wordmark": "В продуктовой навигации отсутствует оригинальный логотип Set Loyalty",
    "setmark-wordmark": "В продуктовой навигации отсутствует оригинальный логотип SetMark",
    "journal-filter-grid": "Журнал нарушений не воспроизводит согласованный набор фильтров",
    "loyalty-product": "Set Mark не показан рядом с Set Loyalty в оболочке Set Centrum",
    "page-breadcrumb": "В верхней панели отсутствует контекст раздела SetMark",
    "access-scenario": "Отсутствует переключатель демонстрационных сценариев доступа",
    "renderJournal": "Отсутствует отдельный экран Журнала нарушений",
    "data-monitoring-nav": "Не отражена иерархия раздела «Мониторинг маркировки»",
    "Лицензии никогда не было": "Не представлен ограниченный лицензионный режим",
    "статус неизвестен, история активна": "Не представлен сценарий неизвестного статуса с историей лицензии",
    "Организация не RU": "Не представлен сценарий страны не RU",
    "data-connect-ecp": "Не работает демонстрационный запуск подключения ЭЦП",
    "Не более 30 дней": "Настройка хранения не ограничена 30 днями",
    "Риск автоштрафа": "В расширенной CSV-выгрузке отсутствует признак риска автоштрафа",
    "set-mark-incidents-23-columns.csv": "Расширенная CSV-выгрузка не содержит 23 согласованные колонки",
