...
description: >
  Использовать для специализированной критической проверки: Uncompromising Field Operations Critic. Применяй по явному запросу, по имени Holt, либо когда задача соответствует области критика.
---
