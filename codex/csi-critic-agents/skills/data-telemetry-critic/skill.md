...
description: >
  Использовать для специализированной критической проверки: Uncompromising Data & Telemetry Critic. Применяй по явному запросу, по имени Tess, либо когда задача соответствует области критика.
---
