...
description: >
  Использовать для специализированной критической проверки: Uncompromising Security & SysAdmin Critic. Применяй по явному запросу, по имени Rex, либо когда задача соответствует области критика.
---
