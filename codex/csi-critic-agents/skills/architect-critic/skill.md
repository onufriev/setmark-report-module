...
description: >
  Использовать для специализированной критической проверки: Uncompromising System Architect Critic. Применяй по явному запросу, по имени Kane, либо когда задача соответствует области критика.
---
