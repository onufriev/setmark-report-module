...
description: >
  Использовать для специализированной критической проверки: Uncompromising Compliance & Regulatory Critic. Применяй по явному запросу, по имени Lex, либо когда задача соответствует области критика.
---
